...
public class ReadingRoom {
    ...
    public synchronized void prepareToRead() throws InterruptedException {
        ...
        while(this.numWritersInside > 0 || this.numWritersWaiting > 0){
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            int randomNumber = rr.random.nextInt(20);
            if(randomNumber%20 == 0) {  // approximately 1/6 of threads should be writers
